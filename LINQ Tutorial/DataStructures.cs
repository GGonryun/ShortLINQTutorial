...
namespace ConsoleApp2
{
    ...
    public class DataStructures
    {
        ...
        private void CreateFoodsList()
        {
            ...
            Foods.Add("Mashed Potato");
            Foods.Add("Sushi");
            Foods.Add("Small Eggs");
            Foods.Add("Applesauce");
            Foods.Add("Mountain Sandwhiches");
            Foods.Add("Instant Milk");
            Foods.Add("Lukewarm Talames");
            Foods.Add("A very small quantity of GoldFish crackers");
            Foods.Add("Potato");
            Foods.Add("Poo");
        }
        private void CreateDoubleArray()
        {
           Doubles = new double[]{ 1.7, 2.3, 1.9, 4.1, 2.9 };
        }
